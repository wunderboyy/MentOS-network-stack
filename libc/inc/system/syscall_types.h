...
#define __NR_sched_setscheduler                                                \
  156 ///< System-call number for `sched_setscheduler`
#define __NR_sched_getscheduler                                                \
  157                        ///< System-call number for `sched_getscheduler`
#define __NR_sched_yield 158 ///< System-call number for `sched_yield`
#define __NR_sched_get_priority_max                                            \
  159 ///< System-call number for `sched_get_priority_max`
#define __NR_sched_get_priority_min                                            \
  160 ///< System-call number for `sched_get_priority_min`
#define __NR_sched_rr_get_interval                                             \
  161                      ///< System-call number for `sched_rr_get_interval`
...
#define __NR_socket 200          ///<  System-call number for 'socket'
#define __NR_bind 201            ///< System-call number for 'bind'
#define __NR_sendto 202          ///< System-call number for 'sendto'
#define __NR_recvfrom 203
#define SYSCALL_NUMBER 204 ///< The total number of system-calls.
...
#define __inline_syscall3(res, name, arg1, arg2, arg3)                         \
  __asm__ __volatile__(                                                        \
    ...
    : "=a"(res)                                                                \
    : "a"(__NR_##name), "ri"((int)(arg1)), "c"((int)(arg2)), "d"((int)(arg3))  \
    : "memory");
