...
syscall_init()
{
  ...
  sys_call_table[__NR_socket] = (SystemCall)sys_socket;
  sys_call_table[__NR_bind] = (SystemCall)sys_bind;
  sys_call_table[__NR_sendto] = (SystemCall)sys_sendto;
  sys_call_table[__NR_recvfrom] = (SystemCall)sys_recvfrom;
